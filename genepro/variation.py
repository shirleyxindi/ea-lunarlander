...
def node_level_crossover(multitree : Multitree, multidonor : Multitree, same_depth : bool=False, prob_swap : float=0.1) -> Node:
  """
...
def __check_tree_meets_all_constraints(multitree : Multitree, constraints : dict=dict()) -> bool:
  """
  """
  meets = True
